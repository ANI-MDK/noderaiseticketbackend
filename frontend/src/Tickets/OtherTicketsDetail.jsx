...
const OtherTicketsDetail = () => {
  ...
  const breadItems = [
    { label: "Home" },
    { label: "Departmental Tickets" },
    { label: "Departmental Tickets Detail", active: true },
  ];
      ...
      <div className="flex w-full gap-2 2xl:gap-3 mt-6">
        ...
        <div className="w-full lg:w-[60%] xl:w-[30%] lg:h-[50vh] 2xl:h-[40vh]  border-[1px] border-black py-2 px-4 rounded-md overflow-y-auto  bg-yellow-50">
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2">
            <div className="text-xs mb-1"><strong>Ticket No: </strong>{" "}<span className="text-blue-500 font-medium text-xs"><Link to="/othertickets">{ticket?.ticket_number}</Link></span></div>
          ...
          <div className="flex flex-col lg:mt-4">
              <button className="bg-[#000] text-white font-semibold px-2 py-1 rounded-md" type="button"onClick={() => navigate("/othertickets")}>Back</button>
          </div>
        </div>
...
export default OtherTicketsDetail;