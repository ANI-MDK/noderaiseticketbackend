...
const AddDepartment = () => {
  ...
  const createDept = async (e) => {
    ...
    const url = `${apiUrl}/department/createdepartment`;
      ...
      <div className="h-auto w-[98.5%] bg-[#342056] border-[1px] border-black flex-col justify-start items-center">
        ...
        >
          <div className="flex flex-col items-start">
            <div className="bg-[#257180] top-0 py-1 w-full text-[#F8E1B7]"><span className="ml-6">Add Department Details</span></div>
            ...
            <div className="w-[55%] flex flex-col gap-2 px-4 relative py-2">
              ...
              <input
                ...
                className="w-full border-[1px] border-[#c5c5c580] py-1 px-3 outline-[#F8E1B7] rounded-lg"
